...
$transaction_id = '78J50825X7857825T';
$amount = 500.00;
$payment_date = date('Y-m-d H:i:s', strtotime('2025-04-07 08:05:15'));

// Start transaction
$conn->begin_transaction();

try {
    // First, find the pending booking(s) with matching total amount
